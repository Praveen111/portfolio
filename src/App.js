...
function App(props) {
  ...
  return (
    <GlobalProvider value={{login:[isLogin,setIsLogin],route:{...props},default:[values,setValues],getMasterData:getMasterData}}>
    <div className="App">
          {/* {isLogin && <AppBar />} */}
          <Switch>
            ...
            <Route  path="/" exact render={() => (<PortfolioHome {...props}/>)} />
          </Switch>
    </div>
    </GlobalProvider>
  );
